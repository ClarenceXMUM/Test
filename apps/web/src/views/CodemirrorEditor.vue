      ...
      >
        <ResizablePanelGroup direction="horizontal">
          ...
          <ResizablePanel :min-size="30">
            <ResizablePanelGroup direction="horizontal" class="inner-panel-group">
              <!-- Markdown 编辑器 -->
              <ResizablePanel
                ref="editorPanelRef"
                :order="1"
              ...
              <ResizableHandle v-show="viewMode === 'split'" with-handle />
...
// 拖动 resize handle 时，防止 CodeMirror / preview 抢夺指针事件
// reka-ui 会在 handle 上设置 data-resize-handle-state="drag"
.inner-panel-group:has([data-resize-handle-state="drag"]) {
  :deep(.cm-editor),
